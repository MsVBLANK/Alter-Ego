...
/**
 * Represents a button message component to advance to the previous page of a menu.
 */
export default class PagePrevInteractable extends PaginationInteractable {
    /**
     ...
     */
    constructor(customId: string, callback: (interaction: BotInteraction) => void, label: string = "Prev", emoji = '⏪', style = ButtonStyle.Secondary, priority = 0, respondWithModal = false) {
